...
// Vagina size
var VaginaSize = map(values[7], 0, 100, 15,35);
//vestibule
  //labia magora 
  fill(255,192,203);
 ...
 //labia manora  clitX,y+length/10, width/4,length/10
  ...
  // line(labiaMinX, labiaMinY, labiaWidth1,labiaWidth1-width/2);
 //  line(labiaWidth1,vagY, labiaMinXB,labiaMinYB);
   
   //Left Labia
bezier(labiaMinX, labiaMinY, labiaWidth1,labiaWidth1Y, labiaWidth1,vagY, labiaMinXB,labiaMinYB);


//line(labiaMinX, labiaMinY, labiaWidth2,labiaWidth2Y);
//line(labiaWidth2,vagY, labiaMinXB,labiaMinYB);
//Right Labia
bezier(labiaMinX, labiaMinY, labiaWidth2,labiaWidth2Y, labiaWidth2,vagY, labiaMinXB,labiaMinYB);

  //ellipse(x+width/2, y, width, length);
   // ellipse(x-width/2, y, width, length);
...
//clit
 fill(0);
 rect(clitX,clitY,width/6,width/6,1);
//clithood

//ureathral opening
 fill(0);
 ellipse(x,y-length/7,VaginaSize/5,VaginaSize/5);
//vagina
