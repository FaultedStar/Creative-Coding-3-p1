...
function setup () {
  ...
  pos3x_slider.parent('slider5Container');
  tilt3_slider.parent('slider6Container');
   pos4x_slider.parent('slider7Container');
   tilt4_slider.parent('slider8Container');
	pos5x_slider.parent('slider9Container');
...
function draw () {
  ...
  stroke(95, 52, 8);
//////////////////////////////// put x sliders here
  drawFromSliders(-50, pos1x_slider, tilt1_slider);
  drawFromSliders(  0, pos2x_slider, tilt2_slider);
  drawFromSliders( 50, pos3x_slider, tilt3_slider);
    drawFromSliders( 100, pos4x_slider, tilt4_slider);
      drawFromSliders( 150, pos5x_slider, tilt5_slider);
}
