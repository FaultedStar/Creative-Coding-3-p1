...
//this is just closed data from the top
 ...
 this.respond = function() {
    var crayon = this.randomCrayon();
    this.colour = color(crayon.hex.toString());
    this.crayonName = crayon.color;
    this.baseColour = this.randomColour();

    this.Gradient(0,0,440,220,this.baseColour,this.colour);
  ...
  //  var message = "Current " + num_owls.toString() + " day weather owl forecast";
   var message = "beep beep " + this.crayonName;
  return message;
  }
}